...
//			re420EndpointUbw32.emulateEndpointMessage("I,00192,00000,00000,24560,00111,00009,00014");
//
//		}
//	}
                ...
                try {
                    switch (event.type) {
                        case Dll.ENUM_CMD_TRACK:
                            ...
                            Dll.Track track = endpointDll.getDll().getTrack(gleisId);
                            // TODO: do something with track...
                            break;
                        case Dll.ENUM_CMD_TRACK_CONNECTION:
                            int gleis1Id = params.get(0);
                            int gleis2Id = params.get(1);
                            Dll.TrackConnection trackConnection = endpointDll.getDll().getTrackConnection(gleis1Id, gleis2Id);
