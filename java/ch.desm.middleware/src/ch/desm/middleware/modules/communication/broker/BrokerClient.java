...
public abstract class BrokerClient implements BrokerClientInterface {
     ...
     * @param message
     */
    protected void publish(BrokerMessageCommon message) {
     ...
     * @param message
     */
    protected void receive(BrokerMessageCommon message) {
     ...
     * @param message
     */
    protected abstract void onIncomingBrokerMessage(BrokerMessageCommon message);
