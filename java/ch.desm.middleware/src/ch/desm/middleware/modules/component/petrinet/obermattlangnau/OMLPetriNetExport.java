...
public abstract class OMLPetriNetExport {
	...
	public int ILTIS__LN_834_6;
	public int ILTIS__LN_6_834;
	...
	public int ILTIS__festgehalten_v_ZB;
	public int ILTIS__P230;
	public int ILTIS__LN_5_834;
	public int ILTIS__anfordern_vZB;
	public int ILTIS__RM_LN_OM;
	public int ILTIS__festhalten_vLN;
	public int ILTIS__RM_moeglich1;
	public int ILTIS__rueckmelden_LN_OM;
	public int ILTIS__P130;
	public int ILTIS__festgehalten_vLN;
	public int ILTIS__RM_moeglich2;
	public int ILTIS__RM_ZB_OM;
	public int ILTIS__rueckmelden_ZB_OM;
	public int ILTIS__freigeben_vLN;
	public int ILTIS__freigeben_vZB;
	public int ILTIS__freigegeben_vZB;
	public int ILTIS__freigegeben_vLN;
	public int ILTIS__anfordern_vLN;
	public int ILTIS__festhalten_vZB;
	...
	public int ext_Vb_KAPUTT4;
	public int ext_Vb_KAPUTT3;
	public int ext_Vb_KAPUTT2;
	public int ext_Vb_KAPUTT;
	...
	public void readSensors() {
		...
		// ILTIS__ZB_138_1 = ?
		// ILTIS__LN_5_834 = ?
		// ILTIS__anfordern_vZB = ?
		// ILTIS__festhalten_vLN = ?
		// ILTIS__rueckmelden_LN_OM = ?
		// ILTIS__rueckmelden_ZB_OM = ?
		// ILTIS__freigeben_vLN = ?
		// ILTIS__freigeben_vZB = ?
		// ILTIS__anfordern_vLN = ?
		// ILTIS__festhalten_vZB = ?
	}
	...
	public boolean fireOneTransition() {
		...
		if ((Fstr_ef__aufgeloest >= 1) && (W1_Endlage_plus >= 1)
		...
		if ((Fstr_ef__aufgeloest <= 0) && (Fstr_ef_verschlossen >= 1)
		...
		if ((Fstr_ef_P6 >= 1) && (Fstr_ef_geprueft1 <= 0) && (Iso_1__frei >= 1)
				&& (Iso_egf_frei >= 1) && (Iso_ef__frei >= 1)) {
		...
		if ((Iso_ef_belegt <= 0) && (Iso_ef__frei >= 1)
		...
		if ((Kontakte_6_FBA_nLN >= 1) && (BL_OM_LN_Grundstlg_n <= 0)
				&& (BL_OM_LN_Grundstlg_v >= 1) && (ILTIS__festgehalten_vLN < 1)) {
		...
		if ((BL_OM_LN_Grundstlg_n >= 1) && (BL_OM_LN_Grundstlg_v <= 0)
				&& (Kontakte_6_FBF_nLN < 1) && (ILTIS__anfordern_vLN >= 1)) {
		...
		if ((BL_OM_LN_3 >= 1) && (BL_OM_LN_RMM_nLN <= 0) && (Iso_1__frei >= 1)) {
		...
		if ((BL_ZB_OM_Grundstlg_v <= 0) && (BL_ZB_OM_Grundstlg_n >= 1)
				&& (Kontakte_6_FBF_nZB < 1) && (ILTIS__anfordern_vZB >= 1)) {
		...
		if ((BL_ZB_OM_RMM_nZB <= 0) && (Iso_1__frei >= 1) && (BL_ZB_OM_3 >= 1)) {
		...
		if ((Kontakte_7_WS1_minus1 >= 1) && (Stw_WS_Sperrm_ein <= 0)
				&& (Stw_WS_Sperrm_aus >= 1) && (Iso_1__frei >= 1)) {
			if (canFire("Stw_T2")) {
				--Kontakte_7_WS1_minus1;
				++Stw_WS_Sperrm_ein;
				--Stw_WS_Sperrm_aus;
		...
		if ((Iso_1__frei >= 1) && (Stw_WS_Sperrm_aus >= 1)
		...
		if ((Fstr_fe_P2 >= 1) && (Iso_ef__frei >= 1) && (Iso_egf_frei >= 1)
				&& (Iso_1__frei >= 1) && (Iso_cd__frei >= 1)
				&& (Fstr_fe_geprueft <= 0)) {
		...
		if ((Iso_1_belegt >= 1) && (Iso_1__frei <= 0)
		...
		if ((Iso_gf_Zug_einfahren >= 1) && (Iso_gf__frei >= 1)
				&& (Iso_gf_belegt <= 0)) {
		...
		if ((Iso_gf__frei <= 0) && (Iso_gf_Zug_ausfahren >= 1)
				&& (Iso_gf_belegt >= 1)) {
		...
		if ((Lampen_1_FBV_vLN <= 0) && (ILTIS__anfordern_vLN >= 1)
				&& (Lampen_P34 >= 1)) {
		...
		if ((Lampen_1_Stoer_Wecker <= 0) && (Lampen_P41 >= 1)) {
		...
		if ((ILTIS__anfordern_vZB >= 1) && (Lampen_1_FBV_vZB <= 0)
				&& (Lampen_P33 >= 1)) {
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS__EMM_1_833 >= 1)
				&& (EMM_geprueft1A1 <= 0)) {
			if (canFire("EMM_T1")) {
				--EMM_EMM_Grundstlg;
				--ILTIS__EMM_1_833;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS__EMM_2_833 >= 1)
				&& (EMM_geprueft1A2 <= 0)) {
			if (canFire("EMM_T2")) {
				--EMM_EMM_Grundstlg;
				--ILTIS__EMM_2_833;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS__EMM_3_833 >= 1)
				&& (EMM_geprueft1A3 <= 0)) {
			if (canFire("EMM_T3")) {
				--EMM_EMM_Grundstlg;
				--ILTIS__EMM_3_833;
		...
		if ((EMM_geprueft1A5 <= 0) && (ILTIS__EMM_5_833 >= 1)
				&& (EMM_EMM_Grundstlg >= 1)) {
			if (canFire("EMM_T5")) {
				++EMM_geprueft1A5;
				--ILTIS__EMM_5_833;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS__EMM_833_1 >= 1)
				&& (EMM_geprueft1E1 <= 0)) {
			if (canFire("EMM_T6")) {
				--EMM_EMM_Grundstlg;
				--ILTIS__EMM_833_1;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS__EMM_833_5 >= 1)
				&& (EMM_geprueft1E5 <= 0)) {
			if (canFire("EMM_T10")) {
				--EMM_EMM_Grundstlg;
				--ILTIS__EMM_833_5;
		...
		if ((ILTIS__LN_834_2 >= 1) && (LN_EMM_Grundstlg >= 1)
				&& (LN_geprueft1E2 <= 0)) {
			if (canFire("LN_T7")) {
				--ILTIS__LN_834_2;
				--LN_EMM_Grundstlg;
		...
		if ((ILTIS__LN_1_834 >= 1) && (LN_geprueft1A1 <= 0)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T1")) {
				--ILTIS__LN_1_834;
				++LN_geprueft1A1;
		...
		if ((ILTIS__LN_5_834 >= 1) && (LN_geprueft1A5 <= 0)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T5")) {
				--ILTIS__LN_5_834;
				++LN_geprueft1A5;
		...
		if ((LN_geprueft1A4 <= 0) && (ILTIS__LN_4_834 >= 1)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T4")) {
				++LN_geprueft1A4;
				--ILTIS__LN_4_834;
		...
		if ((LN_EMM_Grundstlg >= 1) && (ILTIS__LN_834_1 >= 1)
				&& (LN_geprueft1E1 <= 0)) {
			if (canFire("LN_T6")) {
				--LN_EMM_Grundstlg;
				--ILTIS__LN_834_1;
		...
		if ((LN_EMM_Grundstlg >= 1) && (ILTIS__LN_834_5 >= 1)
				&& (LN_geprueft1E5 <= 0)) {
			if (canFire("LN_T10")) {
				--LN_EMM_Grundstlg;
				--ILTIS__LN_834_5;
		...
		if ((ILTIS__LN_2_834 >= 1) && (LN_geprueft1A2 <= 0)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T2")) {
				--ILTIS__LN_2_834;
				++LN_geprueft1A2;
		...
		if ((LN_geprueft1A3 <= 0) && (ILTIS__LN_3_834 >= 1)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T3")) {
				++LN_geprueft1A3;
				--ILTIS__LN_3_834;
		...
		if ((ILTIS__LN_6_834 >= 1) && (LN_geprueft1A6 <= 0)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T105")) {
				--ILTIS__LN_6_834;
				++LN_geprueft1A6;
		...
		if ((ILTIS__ZB_138_2 >= 1) && (ZB_geprueft1E2 <= 0)
				&& (ZB_EMM_Grundstlg >= 1)) {
			if (canFire("ZB_T7")) {
				--ILTIS__ZB_138_2;
				++ZB_geprueft1E2;
		...
		if ((ILTIS__ZB_1_138 >= 1) && (ZB_geprueft1A1 <= 0)
				&& (ZB_EMM_Grundstlg >= 1)) {
			if (canFire("ZB_T1")) {
				--ILTIS__ZB_1_138;
				++ZB_geprueft1A1;
		...
		if ((ILTIS__ZB_138_1 >= 1) && (ZB_geprueft1E1 <= 0)
				&& (ZB_EMM_Grundstlg >= 1)) {
			if (canFire("ZB_T6")) {
				--ILTIS__ZB_138_1;
				++ZB_geprueft1E1;
		...
		if ((ILTIS__ZB_2_138 >= 1) && (ZB_geprueft1A2 <= 0)
				&& (ZB_EMM_Grundstlg >= 1)) {
			if (canFire("ZB_T2")) {
				--ILTIS__ZB_2_138;
				++ZB_geprueft1A2;
		...
		// check if ILTIS__T201 can fire
		if ((ILTIS__festgehalten_vLN >= 1) && (ILTIS__freigegeben_vLN <= 0)
				&& (ILTIS__freigeben_vLN >= 1)) {
			if (canFire("ILTIS__T201")) {
				--ILTIS__festgehalten_vLN;
				++ILTIS__freigegeben_vLN;
				--ILTIS__freigeben_vLN;
				fire("ILTIS__T201");
				return true;
			}
		}
		// check if ILTIS__T202 can fire
		if ((ILTIS__festgehalten_vLN <= 0) && (ILTIS__freigegeben_vLN >= 1)
				&& (ILTIS__festhalten_vLN >= 1)) {
			if (canFire("ILTIS__T202")) {
				++ILTIS__festgehalten_vLN;
				--ILTIS__freigegeben_vLN;
				--ILTIS__festhalten_vLN;
				fire("ILTIS__T202");
		...
		// check if ILTIS__T101 can fire
		if ((ILTIS__freigegeben_vZB <= 0) && (ILTIS__freigeben_vZB >= 1)
				&& (ILTIS__festgehalten_v_ZB >= 1)) {
			if (canFire("ILTIS__T101")) {
				++ILTIS__freigegeben_vZB;
				--ILTIS__freigeben_vZB;
				--ILTIS__festgehalten_v_ZB;
				fire("ILTIS__T101");
				return true;
			}
		}
		// check if ILTIS__T102 can fire
		if ((ILTIS__freigegeben_vZB >= 1) && (ILTIS__festgehalten_v_ZB <= 0)
				&& (ILTIS__festhalten_vZB >= 1)) {
			if (canFire("ILTIS__T102")) {
				--ILTIS__freigegeben_vZB;
				++ILTIS__festgehalten_v_ZB;
				--ILTIS__festhalten_vZB;
				fire("ILTIS__T102");
		...
		// check if ILTIS__T203 can fire
		if ((ILTIS__RM_moeglich2 <= 0) && (ILTIS__P230 >= 1)) {
			if (canFire("ILTIS__T203")) {
				++ILTIS__RM_moeglich2;
				--ILTIS__P230;
				fire("ILTIS__T203");
				return true;
		...
		// check if ILTIS__T204 can fire
		if ((ILTIS__RM_moeglich2 >= 1) && (ILTIS__P230 <= 0)) {
			if (canFire("ILTIS__T204")) {
				--ILTIS__RM_moeglich2;
				++ILTIS__P230;
				fire("ILTIS__T204");
				return true;
		...
		// check if ILTIS__T205 can fire
		if ((ILTIS__RM_moeglich2 >= 1) && (ILTIS__rueckmelden_LN_OM >= 1)
				&& (ILTIS__RM_LN_OM <= 0)) {
			if (canFire("ILTIS__T205")) {
				--ILTIS__RM_moeglich2;
				--ILTIS__rueckmelden_LN_OM;
				++ILTIS__RM_LN_OM;
				fire("ILTIS__T205");
		...
		// check if ILTIS__T103 can fire
		if ((ILTIS__RM_moeglich1 <= 0) && (ILTIS__P130 >= 1)) {
			if (canFire("ILTIS__T103")) {
				++ILTIS__RM_moeglich1;
				--ILTIS__P130;
				fire("ILTIS__T103");
				return true;
		...
		// check if ILTIS__T104 can fire
		if ((ILTIS__RM_moeglich1 >= 1) && (ILTIS__P130 <= 0)) {
			if (canFire("ILTIS__T104")) {
				--ILTIS__RM_moeglich1;
				++ILTIS__P130;
				fire("ILTIS__T104");
				return true;
		...
		// check if ILTIS__T105 can fire
		if ((ILTIS__RM_moeglich1 >= 1) && (ILTIS__RM_ZB_OM <= 0)
				&& (ILTIS__rueckmelden_ZB_OM >= 1)) {
			if (canFire("ILTIS__T105")) {
				--ILTIS__RM_moeglich1;
				++ILTIS__RM_ZB_OM;
				--ILTIS__rueckmelden_ZB_OM;
				fire("ILTIS__T105");
