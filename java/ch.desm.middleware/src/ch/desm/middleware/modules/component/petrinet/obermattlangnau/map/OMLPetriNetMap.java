package ch.desm.middleware.modules.component.petrinet.obermattlangnau.map;
...
public class OMLPetriNetMap extends ComponentMapBase{
	...
	protected void initialize(){
		...
		map.put("1.90.35","Iso_egf_belegt");
		map.put("1.90.36","Iso_1_belegt");
		map.put("1.90.37","Lampen_1_Fstr_ef");
		map.put("1.90.38","Iso_ef_belegt");
		map.put("1.90.39","Iso_cd_belegt");
