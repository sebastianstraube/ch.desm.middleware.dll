...
public class Dll {
    ...
    public static int ENUM_CMD_TRACK = 1;
    public static int ENUM_CMD_TRACK_CONNECTION = 2;
    public static int ENUM_CMD_ISOLIERSTOSS = 3;
    public static int ENUM_CMD_KILOMETER_DIRECTION = 4;
    public static int ENUM_CMD_BALISE = 5;
    public static int ENUM_CMD_SIGNAL = 6;
    public static int ENUM_CMD_LOOP = 7;
    public static int ENUM_CMD_WEICHE = 8;
    public static int ENUM_CMD_TRAINPOSITION = 9;
    public static int ENUM_CMD_STARTSIMULATION = 10;
    public static int ENUM_CMD_STOPSIMULATION = 11;
    public static int ENUM_CMD_LOADSTRECKE = 12;
